...
def plot_image(image: np.ndarray, size: int = 12) -> None:
    ...
    plt.show(block=True)  # Ensure blocking mode

SOURCE_VIDEO_PATH1 = f"/home/finn/ByteTrack/clips/08fd33_0.mp4"
SOURCE_VIDEO_PATH2 = f"/home/finn/ByteTrack/clips/0bfacc_0.mp4"
SOURCE_VIDEO_PATH3 = f"/home/finn/ByteTrack/clips/121364_0.mp4"
SOURCE_VIDEO_PATH4 = f"/home/finn/ByteTrack/clips/2e57b9_0.mp4"
SOURCE_VIDEO_PATH5 = f"/home/finn/ByteTrack/clips/573e61_0.mp4"

TARGET_VIDEO_PATH = f"/home/finn/ByteTrack/clips/2.mp4"


frame_iterator = iter(generate_frames(video_file=SOURCE_VIDEO_PATH5))


WEIGHTS_BEST = f"/home/finn/ByteTrack/best.pt"
WEIGHTS_YOLO = f"/home/finn/ByteTrack/yolov5/yolov5x.pt"
...
frame_iterator = iter(generate_frames(video_file=SOURCE_VIDEO_PATH3))
